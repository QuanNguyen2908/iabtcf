import { sameDataDiffRef } from "@nguyenquan241208/testing";
...
const vendorListJson: any =
  vendorListVersion24Json as unknown as VersionOrVendorList;
...
describe("TCModel", (): void => {
  ...
  it("should construct a TCModel with no arguments", (): void => {
    ...
    expect(tcModel.policyVersion).to.equal(5);
