[![NPM version](https://img.shields.io/npm/v/@nguyenquan241208/core.svg?style=flat-square)](https://www.npmjs.com/package/@nguyenquan241208/core)
[![npm module downloads per month](http://img.shields.io/npm/dm/@nguyenquan241208/core.svg?style=flat)](https://www.npmjs.org/package/@nguyenquan241208/core)
[![InteractiveAdvertisingBureau](https://circleci.com/gh/InteractiveAdvertisingBureau/iabtcf-es.svg?style=shield)](https://circleci.com/gh/InteractiveAdvertisingBureau/iabtcf-es)

# @nguyenquan241208/core
...
npm
```
npm install @nguyenquan241208/core --save
```

yarn
```
yarn add @nguyenquan241208/core
```
...
```javascript
import {TCModel, TCString, GVL} from '@nguyenquan241208/core';
...
import {TCModel, PurposeRestriction, RestrictionType} from '@nguyenquan241208/core';
...
```typescript
import {TCString, TCModel, GVL} from '@nguyenquan241208/core';
...
import {TCString, Segment} from '@nguyenquan241208/core';
